...
void Livro::digitar()
{
  produto.digitar(); // Chamada ao método digitar() do membro Produto
  do
  {
    cout << "Autor: ";
    getline(cin, autor);
...
{
  O << "L: ";
  produto.salvar(O); // Chamada ao método salvar() do membro Produto
  O << ";\"" << autor << "\"";
}

bool Livro::ler(istream &I)
{
  if (!produto.ler(I)) // Chamada ao método ler() do membro Produto
    return false;
...
void CD::digitar()
{
  produto.digitar(); // Chama o método digitar() do membro Produto
  do
  {
...
{
  O << "C: ";
  produto.salvar(O); // Chama o método salvar() do membro Produto
  O << ";" << numFaixas;
}

bool CD::ler(istream &I)
{
  if (!produto.ler(I)) // Chama o método ler() do membro Produto
    return false;
